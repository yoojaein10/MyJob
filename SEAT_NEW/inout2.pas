   ...
   Count := 0;
    ...
    for Count := 0 to Qry_MonList.RecordCount -1 do
      begin
         ...
         begin
           KingCalendar1.SetDateFlag (Qry_MonList.FieldByName('Day').AsInteger, 1, '출근 : '+ Copy( Qry_MonList.FieldByName('OClock').AsString, 1, 2) + ':' + Copy( Qry_MonList.FieldByName('OClock').AsString, 3, 2) );
         end
         else
         begin
           KingCalendar1.SetDateFlag (Qry_MonList.FieldByName('Day').AsInteger, 1, '출근 :');
         end;

         if Qry_MonList.FieldByName('LClock').AsString <> '-' then
         begin
           KingCalendar1.SetDateFlag (Qry_MonList.FieldByName('Day').AsInteger, 3,  '지각 : '+Copy( Qry_MonList.FieldByName('LClock').AsString, 1, 2) + ':' + Copy( Qry_MonList.FieldByName('LClock').AsString, 3, 2) );
         end
         else
         begin
            KingCalendar1.SetDateFlag (Qry_MonList.FieldByName('Day').AsInteger, 3,  '지각 :');
         end;

         if Qry_MonList.FieldByName('OUTClock').AsString <> '-' then
         begin
           KingCalendar1.SetDateFlag (Qry_MonList.FieldByName('Day').AsInteger, 4,  '출장 : '+Copy( Qry_MonList.FieldByName('OUTClock').AsString, 1, 2) + ':' + Copy( Qry_MonList.FieldByName('OUTClock').AsString, 3, 2));
         end
         else
         begin
            KingCalendar1.SetDateFlag (Qry_MonList.FieldByName('Day').AsInteger, 4,  '복귀 :');
         end;

         if Qry_MonList.FieldByName('ComClock').AsString <> '-' then
         begin
           KingCalendar1.SetDateFlag (Qry_MonList.FieldByName('Day').AsInteger, 4,  '복귀 : '+Copy( Qry_MonList.FieldByName('ComClock').AsString, 1, 2) + ':' + Copy( Qry_MonList.FieldByName('ComClock').AsString, 3, 2)  );
         end
         else
         begin
            KingCalendar1.SetDateFlag (Qry_MonList.FieldByName('Day').AsInteger, 4,  '복귀 :');
         ...
         begin
           KingCalendar1.SetDateFlag (Qry_MonList.FieldByName('Day').AsInteger, 2,  '퇴근 : '+Copy( Qry_MonList.FieldByName('ENDClock').AsString, 1, 2) + ':' + Copy( Qry_MonList.FieldByName('ENDClock').AsString, 3, 2)  );
         end
         else
         begin
           KingCalendar1.SetDateFlag (Qry_MonList.FieldByName('Day').AsInteger, 2,  '퇴근 : ');
         end;
    ...
    for Count := 0 to Qry_MonList.RecordCount -1 do
      begin
         ...
         begin
           ...
           KingCalendar1.SetDateFlag (Qry_MonList.FieldByName('Day').AsInteger, 1, '출근 : '+Qry_MonList.FieldByName('OClock').asString);
           KingCalendar1.SetDateFlag (Qry_MonList.FieldByName('Day').AsInteger, 3,  '지각 : '+Qry_MonList.FieldByName('LClock').asString);
           KingCalendar1.SetDateFlag (Qry_MonList.FieldByName('Day').AsInteger, 2,  '출장 : '+Qry_MonList.FieldByName('OUTClock').asString);
           KingCalendar1.SetDateFlag (Qry_MonList.FieldByName('Day').AsInteger, 2,  '복귀 : '+Qry_MonList.FieldByName('ComClock').asString);
         end
...
begin
  ...
  Grid_Detail.Cells[1, 0] := '구 분';
  Grid_Detail.Cells[2, 0] := '이 름';
  Grid_Detail.Cells[3, 0] := '시 간';
