...
implementation
  uses
    Inout, MMS, stats, juso, JUN , WorkList, WorkTong,inout2;
{$R *.dfm}
...
procedure TForm1.CHK_TEAMVIEW;
var
  CHK: string;
begin
//  CHK := 'NO';
//  if DirectoryExists('C:\Program Files (x86)\TeamViewer') then
//  begin
//    CHK := 'YES';
//  end;
//
...
//    Qry.Parameters.ParamByName('Bigo').Value := CHK;
//    Qry.Parameters.ParamByName('name').Value := MyName;
//  // Qry.ExecSQL;
...
begin
  //do_setculdatalogin('IN','','1');    20200629
  //init_cul;
  //do_getCUL;
end;
...
begin
  ...
  if Locate = '0' then Inout2.Form8.showModal;
end;
...
begin
  //ShowMessage('Logout');
  do_SETState(9);
//  do_setculdatalogin('OUT','','9');    20200629
end;
...
procedure TForm1.LGUBaseOpenApi1SendLoginResultEvent(ASender: TObject;
  var bstrLoginResult: WideString);
begin
  //Memo1.Lines.Add('result : ' + bstrLoginResult);
end;
...
begin
 ...
 // DisCon_Connection;
 //  do_setcul(TIMELISTM,'IN','0','4',TIMELISTM.Count);   20200629
