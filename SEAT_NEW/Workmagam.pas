...
begin
 ...
 Grid_LOG.ColCount := 7;
 Grid_LOG.RowCount := 2;
 Grid_LOG.Cells[0, 0] := '감정서번호';
 Grid_LOG.Cells[1, 0] := '업무일자';
 Grid_LOG.Cells[2, 0] := '유치자';
 Grid_LOG.Cells[3, 0] := '작성자';
 Grid_LOG.Cells[4, 0] := '시간';
 Grid_LOG.Cells[5, 0] := '구분';
 Grid_LOG.Cells[6, 0] := '작성일자';
