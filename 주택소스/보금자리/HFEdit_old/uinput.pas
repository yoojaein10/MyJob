...
type
  TXForm1 = class(TXForm)
    ...
    btn_gam: TRzBitBtn;
    qryGamprice: TCurrencyField;
    qryGamDocid: TStringField;
    qryGamReceiptDate: TDateTimeField;
    qryGamManager: TStringField;
    qryGamCharge: TStringField;
    qryGamOwnerName: TStringField;
    qryGamupprice: TCurrencyField;
    qryGamdownprice: TCurrencyField;
    qryGamPricePointDate: TDateTimeField;
    qryGamWriteDate: TDateTimeField;
    qryGamyebi: TCurrencyField;
    qryGamspecialp: TCurrencyField;
    qryGambasicsusu: TCurrencyField;
    qryGamHap: TCurrencyField;
    qryGamTotal: TCurrencyField;
    qryGamBuga: TCurrencyField;
