object Form1: TForm1
    ...
    object Grid: TcxGrid
      ...
      object tvGrid: TcxGridDBTableView
        ...
        object tvGridConsult_Charge: TcxGridDBColumn
          ...
          DataBinding.FieldName = 'Consult_Charge'
          PropertiesClassName = 'TcxLookupComboBoxProperties'
          Properties.KeyFieldNames = 'USR_SEQ'
          Properties.ListColumns = <
            item
    ...
    object PageControl1: TPageControl
      ...
      object TabSheet1: TTabSheet
        ...
        object Edt_Reg_DateTime: TRzDBDateTimePicker
          ...
          Width = 226
          Height = 18
          Date = 44012.784356377310000000
          Format = 'yyyy-MM-dd tt h:mm:ss'
          Time = 44012.784356377310000000
          Font.Charset = HANGEUL_CHARSET
          Font.Color = clWindowText
          Font.Height = -12
          Font.Name = #44404#47548#52404
        ...
        object cxGrid4: TcxGrid
          ...
          object cxGridDBTableView4: TcxGridDBTableView
            ...
            object cxGridDBTableView4ToJi_Build_Total: TcxGridDBColumn
              Caption = #53664#51648','#44148#47932#54633
              DataBinding.FieldName = 'ToJi_Build_Total'
              Options.Editing = False
            end
  ...
  object QRMst: TkbmMWClientQuery
    ...
    CacheFlags = []
    Query.Strings = (
      'exec SP_S_APW_TS_Master NULL, '#39'10'#39', NULL, NULL')
    Params = <>
  ...
  object RzGroupController1: TRzGroupController
    ...
    ParentFont = False
    SelectionFrameColor = clWindowFrame
    Left = 964
    Top = 132
  end
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 42552.440691238400000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      'procedure Memo175OnBeforePrint(Sender: TfrxComponent);'
      'begin'
      '  if <frxMstDataset."Office"> = '#39'24'#39' then'
      '    Memo175.Font.size := 9'
      '  Else'
      '    Memo175.Font.size := 10;'
      'end;'
      ''
      'begin'
      ''
    ...
    object Page1: TfrxReportPage
      ...
      object ReportTitle1: TfrxReportTitle
        ...
        object Memo175: TfrxMemoView
          ...
          Top = 124.724411890000000000
          Width = 447.645950000000000000
          Height = 18.897650000000000000
          OnBeforePrint = 'Memo175OnBeforePrint'
          OnPreviewClick = 'Memo175OnPreviewClick'
          DataSetName = 'fd_gam_info'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -13
          Font.Name = #44404#47548#52404
      ...
      object MasterData1: TfrxMasterData
        ...
        object Memo28: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8 = (
            '[FormatFloat('#39'#,##'#39',<frxLandDataset."UnitCost">)] ')
          ParentFont = False
          VAlign = vaBottom
        end
        object Memo29: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8 = (
            '[FormatFloat('#39'#,##'#39',<frxLandDataset."Total">)] ')
          ParentFont = False
          VAlign = vaBottom
        end
      end
      object MasterData2: TfrxMasterData
        ...
        object Memo86: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8 = (
            '[FormatFloat('#39'#,##'#39',<frxBuildDataset."UnitCost">)] ')
          ParentFont = False
          VAlign = vaBottom
        end
        object Memo87: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8 = (
            '[FormatFloat('#39'#,##'#39',<frxBuildDataset."Total">)] ')
          ParentFont = False
          VAlign = vaBottom
        end
      ...
      object ReportSummary1: TfrxReportSummary
        ...
        object Memo34: TfrxMemoView
          ...
          Memo.UTF8 = (
              ...
              '[FORMATFLOAT('#39'##,###,###,###,##0'#39',<frxMstDataset."Build_Total">)' +
              '] ??')
          ParentFont = False
          VAlign = vaBottom
        end
        ...
        object Memo42: TfrxMemoView
          ...
          Memo.UTF8 = (
              ...
              '[FORMATFLOAT('#39'##,###,###,###,##0'#39',<frxMstDataset."ToJi_Build_Tot' +
              'al">)] ??')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo44: TfrxMemoView
          ...
          Memo.UTF8 = (
              ...
              '[FORMATFLOAT('#39'##,###,###,###,##0'#39',<frxMstDataset."AdjPrice">)] ?' +
              '?')
          ParentFont = False
          VAlign = vaCenter
        end
      ...
      object PageFooter1: TfrxPageFooter
        Height = 52.005256670000000000
        Top = 963.780150000000000000
        Width = 718.110700000000000000
        object Memo36: TfrxMemoView
          Left = 22.677180000000000000
          Width = 677.165740000000000000
          Height = 30.225726670000000000
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -32
          Font.Name = #44404#47548#52404
        ...
        object Memo49: TfrxMemoView
          ...
          Top = 33.219849999999900000
          Width = 301.842920000000000000
      ...
      object MasterData3: TfrxMasterData
        ...
        object Memo31: TfrxMemoView
          ...
          Memo.UTF8 = (
              ...
              '[FORMATFLOAT('#39'##,###,###,###,##0'#39',<frxMstDataset."Toji_Total">)]' +
              ' ??')
          ParentFont = False
          VAlign = vaBottom
        end
