object XForm2: TXForm2
  ...
  Caption = #51452#53469#44552#50997#44277#49324#51032#47280#47785#47197
  ClientHeight = 617
  ClientWidth = 1046
  Color = clBtnFace
    ...
    object Grid_PHF: TcxGrid
      ...
      object Grid_PHFDBTableView1: TcxGridDBTableView
        ...
        object Grid_PHFDBTableView1CHAEMU_TELL2: TcxGridDBColumn
          ...
          DataBinding.FieldName = 'CHAEMU_TELL1'
        end
        object Grid_PHFDBTableView1Column1: TcxGridDBColumn
          Caption = #52292#47924#51088#50672#46973#52376'2'
        ...
        object Grid_PHFDBTableView1Column2: TcxGridDBColumn
          Caption = 'Seq'
  ...
  object qry_KHF: TkbmMWClientQuery
    ...
    CacheFlags = []
    Query.Strings = (
      'EXEC SP_YJI_S_KHF_JSLIST '#39'10'#39)
    Params = <>
  ...
  object qry_PHF: TkbmMWClientQuery
    ...
    CacheFlags = []
    Query.Strings = (
      'EXEC SP_YJI_S_PHF_JSLIST '#39'10'#39)
    Params = <>
    TransportStreamFormat = DBM.ApStreamFormat
    FetchLargeFieldsOnDemand = True
    LargeFieldSize = 256
    ...
    Left = 248
    Top = 484
    object qry_PHFMasterid: TLargeintField
      FieldName = 'Masterid'
      Origin = 'HF_P_Receipt.Masterid'
    end
    object qry_PHFInDate: TDateTimeField
      FieldName = 'InDate'
      Origin = 'HF_P_Receipt.InDate'
    end
    object qry_PHFDAMBO_NO: TStringField
      FieldName = 'DAMBO_NO'
      Origin = 'HF_P_Receipt.DAMBO_NO'
      Size = 10
    end
    object qry_PHFworkgubun: TStringField
      FieldName = 'workgubun'
      Origin = '.'
      Size = 4
    end
    object qry_PHFGAM_EUI_NM: TStringField
      FieldName = 'GAM_EUI_NM'
      Origin = 'HF_P_Receipt.GAM_EUI_NM'
      Size = 30
    end
    object qry_PHFGAM_EUI_JA: TStringField
      FieldName = 'GAM_EUI_JA'
      Origin = 'HF_P_Receipt.GAM_EUI_JA'
      Size = 12
    end
    object qry_PHFGAM_EUI_TEL: TStringField
      FieldName = 'GAM_EUI_TEL'
      Origin = 'HF_P_Receipt.GAM_EUI_TEL'
      Size = 15
    end
    object qry_PHFCHAEMU_NAME: TStringField
      FieldName = 'CHAEMU_NAME'
      Origin = 'HF_P_Receipt.CHAEMU_NAME'
      Size = 30
    end
    object qry_PHFCHAEMU_TELL1: TStringField
      FieldName = 'CHAEMU_TELL1'
      Origin = 'HF_P_Receipt.CHAEMU_TELL1'
      Size = 15
    end
    object qry_PHFCHAEMU_TELL2: TStringField
      FieldName = 'CHAEMU_TELL2'
      Origin = 'HF_P_Receipt.CHAEMU_TELL2'
      Size = 15
    end
    object qry_PHFGUBUN: TStringField
      FieldName = 'GUBUN'
      Origin = '.'
      Size = 22
    end
    object qry_PHFAddress: TStringField
      FieldName = 'Address'
      Origin = '.'
      Size = 151
    end
    object qry_PHFseq: TLargeintField
      FieldName = 'seq'
    end
  end
