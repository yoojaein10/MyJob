...
uses
  ...
  Xmlxform, DB, DBClient, AdvObj, BaseGrid, AdvGrid, ADODB, cxCheckBox,
  ComCtrls, AdvUtil, RzButton, cxCurrencyEdit, cxStyles,
...
type
  ...
  TXForm2 = class(TXForm)
    ...
    qry_PHFseq: TLargeintField;
    Grid_PHFDBTableView1Column2: TcxGridDBColumn;
        ...
        begin
          ...
          Alink.Result := 1;
            ...
            begin
                ...
                Alink.AddParams('Seq', qry_KHF.FieldByName('Masterid').asinteger);
            end
            else  if kind =2 then
            begin
                ALink.AddParams('kind',kind);
                ...
                Alink.AddParams('Seq', qry_PHF.FieldByName('Seq').asinteger);
            end;
...
begin
  ...
  begin
    ...
    query.Text := 'Exec SP_YJI_S_KHF_JSLIST :OFFICE';
  ...
  begin
    ...
    query.Text := 'Exec SP_YJI_S_PHF_JSLIST :OFFICE';
    Params.ParamByName('OFFICE').AsString := UserInfo.Office;
    Open;
