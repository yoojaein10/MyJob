...
begin
  ...
  begin
    ...
    SQL.Text := ' Select Reg, Eub, Bun1, Bun2, Replace(Replace(Left(Building, 5), '' '', ''''), ''동'', '''') Dong, Replace(Replace(Right(Building, 5), '' '' , ''''), ''호'', '''') Ho From Apw_TS_Master Where 1=1 And MasterID = :MasterID ';
