    ...
    try
      ...
      begin
        ...
        Begin
          ...
          if (ANode[Ai].NodeByName('HoNm').ValueAsString = Ho) then
          begin
  ...
  with AField, ANode do begin
    ...
    Begin
      ...
      begin
        ...
        Cells[3, Cnt] := IntToStr(StrToInt(ReadString('ugrndFlrCnt')) + StrToInt(ReadString('grndFlrCnt')));
...
begin
  ...
  begin
    ...
    Edit_TotHouseCnt.Enabled := True;
    Edit_YongDo.Enabled := False;
    Edit_JunPung.Enabled := False;
    Edit_BunM.Enabled := True;
    Edit_BunPung.Enabled := True;
    Edit_GongM.Enabled := False;
    Edit_GongPung.Enabled := False;
    Edit_BuildPung.Enabled := False;

  end
  else if (Gubun = 2) then
  begin

    Edit_TotHouseCnt.Enabled := False;
    Edit_YongDo.Enabled := False;
    Edit_JunPung.Enabled := False;
    Edit_BunM.Enabled := False;
    Edit_BunPung.Enabled := False;
    Edit_GongM.Enabled := False;
    Edit_GongPung.Enabled := False;
    Edit_BuildPung.Enabled := False;
  ...
  begin
    ...
    Edit_TotHouseCnt.Enabled := True;
    Edit_YongDo.Enabled := False;
    Edit_JunPung.Enabled := True;
    Edit_BunM.Enabled := False;
    Edit_BunPung.Enabled := False;
    Edit_GongM.Enabled := True;
    Edit_GongPung.Enabled := True;
    Edit_BuildPung.Enabled := True;
